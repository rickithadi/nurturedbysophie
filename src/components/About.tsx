const About = () => {
  return (
    <section id="about" className="py-16 md:py-24 px-6 bg-sage/10">
      <div className="max-w-7xl mx-auto">
        ...
        <div id="celebrating-motherhood" className="min-h-[80vh] flex flex-col justify-start pt-12 pb-12 md:pt-24 md:pb-0 md:-mb-20 text-center max-w-4xl mx-auto">
