...
export const blogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    sections: [
      ...
      {
        body: 'Most mothers will breastfeed and provide colostrum naturally after birth. However, in some situations, expressing colostrum before birth (called antenatal expressing) can be helpful.',
      },
      {
        heading: 'What is Antenatal Expressing?',
        body: 'Antenatal expressing means hand-expressing and collecting colostrum during late pregnancy (recommended from 36 weeks onwards) to store for your baby after birth. This can be reassuring and build confidence in some families, especially if there is a chance your baby may need extra feeding support in the first 24–48 hours. Having your own colostrum available may also reduce the need for formula supplementation.',
      },
      {
        heading: 'When might it be recommended?',
        body: 'Your midwife and/or obstetrician might suggest antenatal expressing if:',
        list: [
          'You have diabetes during pregnancy — babies can have low blood sugar after birth and the extra colostrum can help keep their blood sugar stable.',
      ...
      {
        body: 'The large Australian DAME study found that women with diabetes in otherwise low-risk pregnancy could safely express colostrum from 36 weeks, with no harm to their babies. Some babies were also less likely to require formula in the first 24 hours.',
      },
      {
